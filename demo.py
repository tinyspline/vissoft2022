# This Python script shows B-Spline morphing in action. Use the slider
# on the bottom of the Tkinter window to evaluate the morphism at
# certain interpolation parameter.
